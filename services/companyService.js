...
const {createCompanyByAdmin,getCompanyDetailsByAdminUserId,updateCompanyByAdmin} = require('../repository/companyRepository')

const createCompanyService = async (body, adminId) => {
    // 1. Validation
    const requiredFields = [
        'name', 'cin', 'pan_number', 'gstin', 'address_line1',
        'city', 'state', 'pincode', 'company_email', 'phone',

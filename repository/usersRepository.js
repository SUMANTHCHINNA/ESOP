...
const checkAdminCompanyDetails = async (adminId) => {
  const sql = "SELECT * FROM companies WHERE admin_user_id = $1 or id = $1";
...
const updateUserDetailsRepository = async (userId, data) => {
  ...
  try {
    ...
    console.error(
      "Database Error in updateUserDetailsRepository:",
      DbError.message
    );
...
const updatePasswordRepository = async (userId, hashedPassword) => {
  try {
    ...
    console.error(
      "Database Error in updatePasswordRepository:",
      DbError.message
    );
    throw DbError;
  }
...
const IspasswordChangedRepository = async (userId) => {
  ...
  try {
    ...
    console.error(
      "Database Error in IspasswordChangedRepository:",
      DbError.message
    );
    throw DbError;
  }
